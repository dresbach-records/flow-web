export type AdProvider = 'google_ad_manager' | 'flow_internal';
...
export interface NativeAdPost { id:string; provider:AdProvider; advertiserName:string; advertiserLogo?:string; headline:string; body?:string; imageUrl?:string; videoUrl?:string; destinationUrl:string; callToAction:string; sponsoredLabel:string; adChoicesUrl?:string; campaignId?:string; placement:string; }
